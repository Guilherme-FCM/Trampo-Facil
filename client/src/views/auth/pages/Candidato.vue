<template>
  <v-container>
    <FormCard>
      ...
      <v-row>
        <v-col>
          <InputText title="Data de Nascimento" type="date" v-model="form.data_nascimento"/>
        </v-col>
        <v-col>
          <v-select
            class="mt-7"
...
import { RegisterCandidato } from '@/types/Auth';
import { reactive } from 'vue';

const form = reactive<RegisterCandidato>({
  nome_completo: '',
  cpf: '',
  data_nascimento: '',
